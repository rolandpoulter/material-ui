...
function getMuiTheme(muiTheme) {
  ...
  muiTheme = (0, _lodash2.default)({
    ...
    stepper: {
      ...
      hoverBackgroundColor: _colorManipulator2.default.fade(_colors.black, 0.06),
      iconColor: palette.primary1Color,
      hoveredIconColor: _colors.grey700,
      inactiveIconColor: _colors.grey500,
      textColor: _colorManipulator2.default.fade(_colors.black, 0.87),
      disabledTextColor: _colorManipulator2.default.fade(_colors.black, 0.26),
