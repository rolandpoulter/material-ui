...
exports.default = {
   ...
   */
  convertColorToString: function convertColorToString(color, additonalValue) {
  ...
  convertHexToRGB: function convertHexToRGB(color) {
    if (color.length === 4) {
      var extendedColor = '#';
  ...
  decomposeColor: function decomposeColor(color) {
    if (color.charAt(0) === '#') {
